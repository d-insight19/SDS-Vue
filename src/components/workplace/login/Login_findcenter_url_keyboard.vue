            ...
            <div class="inner">
                ...
                <ul class="ulList type2">
                    <li>
                        ...
                        <slp-text-field placeholder="http://" ref="refInput" @focus="focusToggle" class="search-wrapper" clearable ><button class="close-icon" type="button" @click="delTxt"></button></slp-text-field>
                    </li>
                </ul>
                <!-- //list -->
            </div>
