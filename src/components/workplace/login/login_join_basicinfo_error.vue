            ...
            <div class="inner">
                ...
                <ul class="ulList type1">
                    ...
                    <li>
                        ...
                        <slp-text-field placeholder="성명 입력" value="정해민" error message="성명을 입력해주세요."></slp-text-field>
                    </li>
                    <li>
                        ...
                        <div class="intSchBox">
                            <div class="search-wrapper">
                                <input ref="refInput" type="password" value="1234" pattern="^\s+" class="input err" placeholder="8~12자의 숫자와 영문자, 특수문자를 조합하세요" />
                    ...
                    <li>
                        ...
                        <div class="intSchBox">
                            <div class="search-wrapper">
                                <input ref="refInput2" type="password" value="1234" pattern="^\s+" class="input err" placeholder="8~12자의 숫자와 영문자, 특수문자를 조합하세요" />
                                <a href="#" class="btn eye" v-show="password_show" @click="passwordtoggle"><span class="ico"></span></a>
                                <a href="#" class="btn eye eye_slash" v-show="!password_show" @click="passwordtoggle"><span class="ico"></span></a>
                    ...
                    <li>
                        ...
                        <div class="rdoSelBox ">
                            <label class="labelRdo"><input type="radio" class="rdo" name="gender-rdo" checked><span class="ico"></span><span class="label">남자</span></label>
                    ...
                    <li>
                        ...
                        <div class="birthInt">
                            <slp-select required placeholder="년도" class="">
                                <option>2017</option>
                                <option>2018</option>
                                <option>2019</option>
                                <option>2020</option>
                            </slp-select>
                            <slp-select required placeholder="월" class="">
                                <option>2017</option>
                                <option>2018</option>
                                <option>2019</option>
                                <option>2020</option>
                            </slp-select>
                            <slp-select required placeholder="일" class="">
                                <option>2017</option>
                                <option>2018</option>
                                <option>2019</option>
                                <option>2020</option>
                    ...
                    <li>
                        ...
                        <slp-text-field value="multicampus@multi.co.kr" placeholder="이메일을 입력하세요" error message="이메일 주소를 입력해주세요."></slp-text-field>
                    </li>
                    <li>
                        <strong class="label-tit require_mark">휴대전화</strong>
                        <slp-text-field value="01029384029" placeholder="‘-‘ 없이 숫자만 입력하세요" error message="‘-’ 또는 띄어쓰기 없이 10자 이상 입력해주세요."></slp-text-field>
                    </li>                    
                    <li>
