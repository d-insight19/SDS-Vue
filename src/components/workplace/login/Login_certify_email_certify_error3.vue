            ...
            <div class="inner">
                ...
                <ul class="ulList type1">
                    <li>
                        ...
                        <slp-text-field placeholder="성명을 입력하세요" value="홍길동" ></slp-text-field>
                    </li>
                    <li>
                        <strong class="label-tit">이메일</strong>
                        <div class="emailChk">
                          <slp-text-field placeholder="이메일을 입력하세요"  value="multi12@mulcam.com"></slp-text-field>
                    ...
                    <li v-show="sendFlag">
                        ...
                        <div class="emailChk">
                            <slp-text-field placeholder="인증번호를 입력하세요" error message="유효시간이 초과되었습니다 인증번호를 다시 전송해주세요"></slp-text-field>
                            <span class="time">
