        ...
        <div id="content" class="normal">
          <div class="cell">
            <div class="inner">
                ...
                <p class="font_15 fwr mono_80 mb15">2018.11.01~2018.11.30</p>
                <p class="font_15 fwb mb4">학습시간</p>
                <p class="font_15 fwr mono_80 mb15">09:00 ~ 18:00(8시간/1일)</p>
                <p class="font_15 fwb mb4">신청기간</p>
                <p class="font_15 fwr mono_80 mb15">2018.11.10 ~ 2018.11.30</p>
                <p class="font_15 fwb mb4">교육비 지원</p>
                <p class="font_15 fwr mono_80">고용보험 비환급/QR출결</p>
                <p class="font_15 fwr mono_80 mb15">우선기업 50,000원</p>
                <p class="font_15 fwb mb4">교육비 </p>
                <p class="font_15 fwr mono_80 mb15">440,000원(VAT 없음)</p>
                ...
                <p class="font_15 fwb mb4">정원</p>
                <p class="font_15 fwr mono_80 mb15">25명</p>
                <p class="font_15 fwb mb4">교육수준</p>
                <p class="font_15 fwr mono_80 mb15">핵심</p>
                ...
                <slp-button class="sm mb40 fwb mono_100">과정 안내서 보기 (PDF)</slp-button>
            </div>
          </div>
