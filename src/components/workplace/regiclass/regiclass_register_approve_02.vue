          ...
          <div class="cell">
            <div class="inner">
                ...
                <p class="label-tit-14" style="margin-top:20px; margin-bottom:10px; width: 100%;">
                    ...
                    <span class="fr fwb color_clr2" @click="editList()" >{{languageTxt}}</span>
                </p>
                ...
                <ul class="ulList type2">                    
                    <li v-for="item in list1" :key="item.id" >
                        ...
                        <span v-if="languageEditFlag" class="ico list-btn" ></span>
                        <span v-else="" class="ico del"  @click="deleteList(index)" ></span>
                    </li>
                </ul>
