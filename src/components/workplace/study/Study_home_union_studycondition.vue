      ...
      <div id="container" class="mediaquery courseware union" >
            ...
            <div class="hide_header">
                ...
                <div class="study_title_wrap">
                    ...
                    <div class="study_contens_title">
                        <p class="multiline line2">[전화외국어] 쉽게 배우는 스피킹, 외국에서 사용하는 실생활 용어</p>
                    </div>
        ...
        <div id="content" class="normal" >
            ...
            <div class="inner pt0">
                ...
                <p class="label-tit-16 color_clr2 mt22 mb26 fwb"><span class="ico mark_line_24 blue" style="vertical-align: -5px;"></span> 과정 MAP 보기</p>

                <div class="tb_wrap">
                    <table>
                        <tr>
                            <td class="mono_80">수료상태</td>
                            <td class="font_18 fwb tar">미수료</td>
                        </tr>
                        <tr>
                            <td class="mono_80">총점평균</td>
                            <td class="font_18 fwb tar">82.2점</td>
                        </tr>
                    </table>
                </div>
            </div>
