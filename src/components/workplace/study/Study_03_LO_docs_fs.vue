      ...
      <div id="container" class="mediaquery study_dictionary_de">
            ...
            <div id="header" class="fixed">
              ...
              <div class="page-btn">
                  ...
                  <div class="num"><span class="color_clr2">3</span> / <span>36</span></div>
