        ...
        <div id="header" class="tab video">          
            ...
            <div class="header_inner line2 tabMenu scroll-x">
                <ul class="scrollTab">
                    ...
                    <li class="on"><a href="#tab2">용어사전</a></li> 
                ...
                <ul class="ulList type4">                    
                    <li>
                        <div class="d_flex align_items_center">
                            <div class="d_flex_col w_min_0">
                                <p class="title">교차 케이블</p>
                                <p class="fwb mono_65 text-truncate">반대로 교차두 컴퓨터의 케이블 핀의 접점을 각각 반대로 교차두 컴퓨터의 케이블 핀의 접점을 각각 반대로 교차두 컴퓨터의 케이블 핀의 접점을 각각 반대로 교차두 컴퓨터의 케이블 핀의 접점을 각각 반대로 교차두 컴퓨터의 케이블 핀의 접점을 각각 반대로 교차</p>                              
                            </div>
                            <div class="d_flex_col"><span class="ico arrow"></span></div>
                        </div>
                    </li>
                    <li>
                        <div class="d_flex align_items_center">
