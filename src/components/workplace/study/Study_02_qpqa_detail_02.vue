    ...
    <div id="wrap" class="colorCode2">
        ...
        <div id="container" class="mediaquery study_qpqa ">
            ...
            <div id="content" class="normal">
                <div class="cell">
                    <div class="inner">
                        ...
                        <p class="inner-txt op65 mb20">모든 글이 사람들에게 다가갈 수 있는 것은 아니다. 제대로 쓰여진 글만이 사람들에게 신뢰와 재미를 줄 수 있다. 그래서 글을 제대로 쓰는 것은 중요하다.</p>
                        <input @input="onInput" v-model="inp" type="text" class="input" placeholder="의견을 입력해주세요."/>
            ...
            <div class="fixBtmBtn abs">
                <button type="button" class="btn md" :class="{clr1: inp}">확인</button>
            </div>
            <!-- //floatingbtn -->
        </div>
        <!-- //container -->
