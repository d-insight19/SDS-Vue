                ...
                <div class="cell">
                    <div class="inner">              
                        ...
                        <div class="record_box">
                            <ul class="record_tb">
                                <li>
                                    <button class="btn-md fwr w76 mb0">초기화</button>
                                </li>
                                <li>
                                    <div class="circle">
                                        <img src="@/assets/img/ic_record_pause_40.png" alt="">
                                    </div>
                                </li>
                                <li>
                                    <button class="btn-md  fwr mb0 clr2 clr_wh">등록</button>
                                </li>
                            </ul>
