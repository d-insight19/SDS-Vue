<template>
 <!-- eslint-disable -->
    ...
    <div id="wrap" class="colorCode2">        
        <!-- container -->
        <div id="container" class="mediaquery study_quiz_ox bg intro">
            <!-- op-bg -->
            ...
            <!-- floatingbtn -->
            <ul class="btmBtn"><li><button type="button" class="btn">응시하기<span class="ico gray_next"></span></button></li> </ul>
            <!-- //floatingbtn -->
