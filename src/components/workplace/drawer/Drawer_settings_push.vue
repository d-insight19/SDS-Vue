            ...
            <div id="content" class="normal">
                <div class="cell">
                    ...
                    <ul class="multiList type4">
                        ...
                        <li class="pb20">
                            <strong class="label-tit14" placeholder="선택">타임존</strong>
                            <select class="select w100p mt8">
                            <option>선택</option>
                            <option>선택</option>
                            <option>선택</option>
                    ...
                    <ul class="multiList type1">
                        <li>
                            <strong class="label-tit16">푸시 알림</strong>
